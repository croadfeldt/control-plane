...
func (c *Client) DeleteInstance(ctx context.Context, instanceId InstanceIdPath, params *DeleteInstanceParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteInstanceRequest(c.Server, instanceId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetInstance(ctx context.Context, instanceId InstanceIdPath, params *GetInstanceParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetInstanceRequest(c.Server, instanceId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewDeleteInstanceRequest(server string, instanceId InstanceIdPath, params *DeleteInstanceParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Deferred != nil {

			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "deferred", *params.Deferred, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func (c *ClientWithResponses) DeleteInstanceWithResponse(ctx context.Context, instanceId InstanceIdPath, params *DeleteInstanceParams, reqEditors ...RequestEditorFn) (*DeleteInstanceResponse, error) {
	rsp, err := c.DeleteInstance(ctx, instanceId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetInstanceWithResponse(ctx context.Context, instanceId InstanceIdPath, params *GetInstanceParams, reqEditors ...RequestEditorFn) (*GetInstanceResponse, error) {
	rsp, err := c.GetInstance(ctx, instanceId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
